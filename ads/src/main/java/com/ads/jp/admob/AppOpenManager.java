                    ...
                    public void onAdLoaded(AppOpenAd ad) {
                        ...
                        if (!isSplash) {
                            ...
                            AppOpenManager.this.appResumeAd.setOnPaidEventListener(adValue -> {
                                JPLogEventManager.logPaidAdImpression(myApplication.getApplicationContext(),
                                        adValue,
                                        ad.getAdUnitId(),
                                        ad.getResponseInfo()
                                                .getMediationAdapterClassName(), AdType.APP_OPEN);
                                JPLogEventManager.logPaidAdjustWithToken(adValue, ad.getAdUnitId(), JPAdConfig.ADJUST_TOKEN_TIKTOK);
                            });
                    ...
                    splashAd.setFullScreenContentCallback(
                            new FullScreenContentCallback() {
                                ...
                                public void onAdClicked() {
                                    super.onAdClicked();
                                    if (currentActivity != null) {
                                        JPLogEventManager.logClickAdsEvent(currentActivity, splashAdId);
                                        if (fullScreenContentCallback != null) {
            ...
            if (appResumeAd != null) {
                appResumeAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdClicked() {
                        super.onAdClicked();
                        if (currentActivity != null) {
                            JPLogEventManager.logClickAdsEvent(currentActivity, appResumeAdId);
                            if (fullScreenContentCallback != null) {
                                fullScreenContentCallback.onAdClicked();
                            }
                        }
                        ...
                        appOpenAd.setOnPaidEventListener(adValue -> {
                            JPLogEventManager.logPaidAdImpression(myApplication.getApplicationContext(),
                                    ...
                                    appOpenAd.getResponseInfo()
                                            .getMediationAdapterClassName(), AdType.APP_OPEN);
                            JPLogEventManager.logPaidAdjustWithToken(adValue, appOpenAd.getAdUnitId(), JPAdConfig.ADJUST_TOKEN_TIKTOK);
                        });
                                    ...
                                    timerListenInter = new CountDownTimer(time, 1000) {
                                        ...
                                        public void onTick(long l) {
                                            if (statusInter == Type_Load_Success && !isAppOpenShowed) {
                                                isAppOpenShowed = true;
                                                Admob.getInstance().onShowSplash(activity, adListener, splashAdInter, JPAdConfig.ADJUST_TOKEN_TIKTOK);
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        interstitialAd.setOnPaidEventListener(adValue -> {
                            JPLogEventManager.logPaidAdImpression(activity,
                                    adValue,
        ...
        new Handler().postDelayed(() -> {
            splashAd.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            JPLogEventManager.logClickAdsEvent(context, splashAdId);
