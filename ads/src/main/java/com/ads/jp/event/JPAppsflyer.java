...
public class JPAppsflyer {
    private static final String TAG = "JPAppsflyer";
    private Context context;
    private static JPAppsflyer jpAppsflyer;
    public static boolean enableAppsflyer = false;

    public JPAppsflyer() {
    }

    public static JPAppsflyer getInstance(){
        if (jpAppsflyer ==null)
            jpAppsflyer = new JPAppsflyer();
        return jpAppsflyer;
    }
