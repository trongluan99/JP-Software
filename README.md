...
~~~
    ...
    implementation 'com.github.trongluan99:JP-Studio:$version'
...
~~~   
JPAd.getInstance().loadSplashInterstitialAds(this, BuildConfig.ad_interstitial_splash, 25000, 5000, new AdCallback() {
            @Override
